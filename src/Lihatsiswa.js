...
export default class Lihatsiswa extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
  ...
  componentDidMount()  {
      const url = 'http://gusnando.com/mobile/angga/daftarsiswa.php';
  ...
  render() {
    return (
      ...
      <View style={styles.Header}>
          <Text style={styles.TextHeader}>Data Siswa Baru</Text>
      </View>
        <FlatList
